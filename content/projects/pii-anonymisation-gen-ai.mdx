...
shortTitle: "PII Anonymisation: Agentic"
description: Built a fully local document anonymiser that combines NER, generative replacement, and adversarial re-identification, improving anonymisation from 87% to 97%.
image: /images/projects/gen-ai-anonymizer.png
date: "2025-11-21"
homepageOrder: 3
authors:
  - shariff-rashid
...
projectType: "AI/ML"
highlights:
  - Hybrid pipeline with NER, segmentation, and generative anonymisation
  - Adversarial optimization to balance privacy and utility
  - Built an end-to-end workflow for sensitive document sharing
---

[Presentation Slides](https://www.canva.com/design/DAG4oXnfOIg/kJ77F4Jw_zNdsort6ZPHTQ/view?utm_content=DAG4oXnfOIg&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h1aa0682a35)
...
- _Sampling:_ 10k / 2k / 2k examples for train / validation / test.
...
- _Challenge:_ It does not provide clean character-aligned span annotations; PII spans must be inferred (weakly supervised).
- _Constraint:_ We used a Diff + “Xx” constraint, focusing only on differences where the redacted version contains placeholder patterns.
- _Split:_ 2,158 train, 270 validation, 270 test notes.
...
1.  Alemi, A. A., & Ginsparg, P. (2015). Text segmentation based on semantic word embeddings. _arXiv preprint arXiv:1503.05543_.
2.  Beeferman, D., Berger, A., & Lafferty, J. (1999). Statistical models for text segmentation. _Machine learning, 34_, 177-210.
3.  Staab, R., Vero, M., Balunović, M., & Vechev, M. (2024). Large language models are advanced anonymizers. _arXiv preprint arXiv:2402.13846_.
4.  Yang, T., Zhu, X., & Gurevych, I. (2025). Robust utility-preserving text anonymization based on large language models. _ACL 2025_.
5.  Zhou, Y., et al. (2022). Large language models are human-level prompt engineers. _ICLR 2023_.
