...
Sensitive domains such as healthcare, legal, and finance often need to share rich, narrative documents that are full of personally identifiable information (PII). Traditional rule-based redaction methods tend to be brittle and frequently over-remove content, harming the utility of the text.
