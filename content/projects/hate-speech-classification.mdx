---
title: Hate Speech Classification with BERT
shortTitle: "Hate Speech with BERT"
description: Full RoBERTa fine-tuning reached 0.689 macro-F1; LoRA trained only 0.71% of the parameters but fell to 0.630.
image: /images/projects/hate-speech-bert.png
date: "2025-10-18"
homepageOrder: 4
authors:
  - shariff-rashid
...
projectType: "AI/ML"
highlights:
  - Fine-tuned RoBERTa vs BERT and HateBERT for hate speech detection
  - Compared full fine-tuning against LoRA with performance trade-offs
  - Achieved Macro F1 0.689 with updated hyperparameter sweep
---

- [Presentation Slides](https://www.canva.com/design/DAG1v66uXGk/coc8CULWqxmp3e_7ncZJKA/view?utm_content=DAG1v66uXGk&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=haba9ae8d4d)
...
- _Config:_ LR=2e-4, 8 Epochs (capped due to overfitting).

**Key Observations:**

1.  **Training Speed:** LoRA was _not_ faster (7 mins vs 7 mins for full FT) due to the increased epoch count needed for convergence.
