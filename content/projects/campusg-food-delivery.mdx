...
shortTitle: "CampusG Food Delivery"
...
projectType: "SWE"
highlights:
  - Built microservices platform with saga orchestration
  - Integrated Kafka messaging and Temporal workflows
  - Deployed full stack on AWS with observability
---
