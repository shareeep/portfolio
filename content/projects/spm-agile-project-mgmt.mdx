---
title: Software Project Management with Agile Scrum
shortTitle: "Agile Development; Proj Mgmt."
...
image: /images/projects/spm-cover.png
date: "2025-11-07"
authors:
  - shariff-rashid
tags:
...
projectType: "SWE"
highlights:
  - Led Scrum ceremonies and delivery cadence
  - Implemented CI pipeline with pre-push hooks 
  - Managed Jira workflow and velocity calibration
---
...
- **Format:** Stories followed the standard template: _"As a [role], I want to [feature], in order to [benefit]."_
...
1.  **Local Layer (Pre-push Hooks):**
    ...
    - **Backend:** Unit tests run only on _changed services_ (70% coverage enforced).
    - **Security:** Optional Gitleaks scan.
    - _Benefit:_ Catches integration errors locally, ensuring only stable builds reach the remote repo.
...
2.  **Cloud Layer (GitHub Actions):**
    ...
    - _Benefit:_ Acts as the official merge gatekeeper, ensuring high reliability and stable merges.
