...
shortTitle: "PetConnect Social Platform"
...
projectType: "SWE"
highlights:
  - Built Vue + Express web app with Firebase backend
  - Shipped real-time chat and events discovery
  - Deployed full-stack services on Render
---

## Overview

Developed for the **IS216 Web App Development 2** module, PetConnect is a web application designed to connect pet owners with pet lovers.
