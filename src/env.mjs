...
export const env = createEnv({
  server: {
    ...
    // DATABASE_URL: z.string().min(1).optional(), // Removed as database is no longer used
  ...
  client: {
    NEXT_PUBLIC_APP_URL: z.string().min(1), // Keeping this required for now
  },
  runtimeEnv: {
    ...
    // DATABASE_URL: process.env.DATABASE_URL, // Removed
