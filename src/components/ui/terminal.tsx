...
export const Terminal = ({
  ...
  useEffect(() => {
    ...
    onSequenceComplete()
  }, [sequence, sequenceHasStarted, onSequenceComplete, itemCount, activeIndex])

  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 size-full max-h-[400px] max-w-lg rounded-xl border",
        className
      )}
    >
      {header ? (
      ...
      <pre className={cn("p-4", header ? "pt-3" : null)}>
